---
description: Analyze a skill's mechanics, design rationale, and how to build something similar
...
The skill to explain (if provided): `$ARGUMENTS`

## Input

The user provides a skill name (e.g., `10x-plan`, `10x-shape`, `10x-new`) — passed as `$ARGUMENTS` above. Accept it as:
