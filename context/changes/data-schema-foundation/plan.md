...
- [x] 2.1 TypeScript compilation passes: `npx tsc --noEmit` — e643da3
- [x] 2.2 Lint passes: `npm run lint` — e643da3

#### Manual

- [x] 2.3 IDE autocomplete resolves all entity fields correctly from an import of `Transaction` — e643da3
